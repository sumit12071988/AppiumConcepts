...
// ******** TO LOCATE THE APK FILE INSIDE THE PROJECT DIRECTORY ***********
		...
		File app = new File(appDir,"original.apk");		// My APK FILE NAME is ApiDemos-debug.apk | original.apk
...
//	************************************************************************	
		...
		if (device.equalsIgnoreCase("virtual")) {
			...
			// ce061606337acd1903 --> My Read Device in Wired Mode
...
// ******************** ESTABLISHING CONNECTION B/W APPIUM SERVER & EMULATOR | ESTABLISHING SESSION ***********************
		...
		//	before running another RunningBATFile. If we've to run the script again before 60 seconds, then we need to close the APPIUM Server (CTRL+C) and open it again
